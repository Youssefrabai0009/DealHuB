  ...
  <div class="main-content">
    <div class="pitch-container">
      ...
      <div class="video-grid" id="videoContainer">
        <!-- Exemple, à remplacer par du PHP dynamique si besoin -->
        <div class="video-card" data-categorie="agriculture">
          <video src="tech.mp4" controls></video>
          <div class="video-info">
            <h5>Pitch Startup 1</h5>
            <p>Catégorie : agriculture</p>
            <a href="addoffre.php?categorie=chefaa" class="btn-success">
        ...
        <div class="video-card" data-categorie="technologie">
          ...
          <div class="video-info">
            ...
            <a href="addoffre.php?categorie=Technologie" class="btn-success">
              <i class="fas fa-plus"></i> Ajouter une offre
            </a>
          </div>
        </div>
