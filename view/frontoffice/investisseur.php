...
// Check if the user is logged in and has the "investisseur" role
if (!isset($_SESSION['user']) || !isset($_SESSION['user']['role']) || $_SESSION['user']['role'] !== 'investisseur') {
    header("Location: login.html");
    exit;
}

$user = $_SESSION['user'];
$userEmail = isset($user['email']) ? htmlspecialchars($user['email']) : 'investisseur@example.com';
?>
