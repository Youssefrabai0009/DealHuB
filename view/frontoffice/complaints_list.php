...
<body>
    ...
    <div class="main-content">
        <div class="pitch-container">
            <h1>My Complaints</h1>
            <button class="add-speech-btn" onclick="window.location.href='/wissal/DealHuB/controller/ComplaintsController.php?action=add'">Add Complaint</button>
                ...
                <?php foreach($complaints as $complaint): ?>
                    <div class="card p-6 rounded shadow">
                        ...
                        <div class="flex justify-between items-center mt-4">
                            <a href="/wissal/DealHuB/controller/ComplaintsController.php?action=edit&id=<?= $complaint['id'] ?>" class="btn-primary px-3 py-1 rounded">Edit</a>
                            <a href="/wissal/DealHuB/controller/ComplaintsController.php?action=view_complaint_replies&id=<?= $complaint['id'] ?>" class="btn-primary px-3 py-1 rounded">Check Replies</a>
                            <a href="/wissal/DealHuB/controller/ComplaintsController.php?action=delete&id=<?= $complaint['id'] ?>" class="btn-danger px-3 py-1 rounded" onclick="return confirm('Êtes-vous sûr ?')">Delete</a>
                        </div>
                    </div>
                <?php endforeach; ?>
            </div>
