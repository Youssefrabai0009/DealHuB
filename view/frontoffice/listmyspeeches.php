...
<head>
    ...
    <script>
        ...
        async function generateContractPdf(equity, amount) {
            ...
            const bgUrl = '/wissal/DealHuB/view/frontoffice/images/pdfbg.jpg';
            ...
            // Load logo image
            const logoUrl = '/wissal/DealHuB/view/frontoffice/images/logoimage11.png';
...
<body>
    <video autoplay muted loop playsinline id="bg-video">
        <source src="C:\xampp\htdocs\wissal\dealhub\view\video\backgroundloop.mp4" type="video/mp4" />
    ...
    <div class="main-content">
        <div class="pitch-container">
            <h1>My speech</h1>
<button class="add-speech-btn" onclick="window.location.href='./add_speech.php'">Add Speech</button>
...
$entrepreneur_id = $_SESSION['user']['id']; // Use logged-in user ID from session //temporaryspeech
            ...
            foreach ($speeches as $speech) {
                ...
                echo "<a href='/wissal/dealhub/view/frontoffice/update_speech.php?id={$speech['ID_speech']}' class='boost-btn'>Update Speech</a>";
...
function boostSpeech(speechId) {
    window.location.href = './boost_speech.php?id=' + speechId;
}
        ...
        <script>
            ...
            function sendMessageToInvestor(investorName) {
                ...
                if (!message) return;
                 ...
                 fetch('../../controller/send_twilio_message.php', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
