  ...
  <div class="flex h-screen">
    ...
    <aside class="w-64 bg-white shadow-md">
      ...
      <nav class="space-y-2 px-6">
        ...
        <a href="offres.php" class="block text-blue-700 hover:text-blue-500">Gestion offres</a>
  ...
  <tbody>
    <?php foreach ($list as $offre): ?>
      <tr>
        ...
        <td>
          <a href="deleteoffres.php?id_offre=<?= $offre['id_offre'] ?>" class="btn btn-sm btn-danger" title="Supprimer"
